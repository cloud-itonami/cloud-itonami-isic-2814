(ns beargearmfg.phase
  "Phase 0->3 staged rollout for the bearings/gears/gearing/driving-
  elements (ball bearings, roller bearings, spur/helical/worm gears)
  ...
  consequence (a machining/grinding-line-equipment maintenance window
  means production downtime, and the equipment ends up actually
  touched); it is always a human plant supervisor's call.
  `beargearmfg.governor`'s `equipment-actuate-blocked-violations`
...
(defn verdict->disposition
  "Map a Bearings, Gears and Driving Elements Plant Operations
  Governor verdict to a base disposition before the phase gate."
  [verdict]
