# Operator Quickstart — Manufacture of bearings, gears, gearing and driving elements

Shortest path from clone to a verified local dry-run for **ISIC 2814** (`cloud-itonami-isic-2814`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-2814.git
cd cloud-itonami-isic-2814
```
...
- Blueprint governor key: `bearings-gears-plant-operations-governor`
- Likely source path: `beargearmfg.governor.cljc`
